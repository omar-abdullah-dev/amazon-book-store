...
<div class="container my-5" style="max-width: 550px;">
    <div class="header text-center mb-4">
        ...
        <p class="text-secondary">Enter category name to organize books</p>
    </div>
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body p-4">
            <form:form action="${pageContext.request.contextPath}/category/saveCategory" modelAttribute="category" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <form:input path="categoryName" id="categoryName" 
                                ...
                                placeholder="e.g. Computer Science, Science Fiction" required="required" />
                    <c:if test="${not empty nameError}">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="${pageContext.request.contextPath}/category/list" class="btn btn-secondary px-4">
                        Cancel
                    </a>
                </div>
