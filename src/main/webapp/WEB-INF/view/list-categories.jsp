...
<head>
    ...
    <title>Amazon Book Store - Categories</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="amazonNav">
            ...
            <div class="d-flex align-items-center gap-2 mt-2 mt-lg-0">
                ...
                <a href="${pageContext.request.contextPath}/category/showFormForAdd" class="btn btn-amazon shadow-sm btn-sm">
...
<div class="container my-5" style="max-width: 850px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold mb-1"><i class="bi bi-tags text-primary me-2"></i>Categories</h3>
            <p class="text-secondary m-0">Manage genres and book classification</p>
        </div>
        <a href="${pageContext.request.contextPath}/category/showFormForAdd" class="btn btn-amazon shadow-sm">
            <i class="bi bi-plus-circle me-1"></i> + Add Category
        </a>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-3 mb-3">
        <div class="card-body p-2">
            <div class="input-group">
                ...
                <input type="text" id="categorySearchInput" class="form-control border-0 shadow-none" 
                       placeholder="Search categories by name or ID..." onkeyup="filterCategories()">
                <button class="btn btn-link text-muted pe-3 text-decoration-none" type="button" onclick="clearCategorySearch()" title="Clear search">
                    ...
                    <tbody>
                        <c:forEach var="tempCategory" items="${categories}">
                            ...
                            <tr class="category-row">
                                <td class="ps-4 fw-semibold text-muted category-id">#${tempCategory.id}</td>
                                <td>
                                    <span class="badge badge-category px-3 py-2 fs-6 category-name">
                                        <i class="bi bi-tag me-1"></i>${tempCategory.categoryName}
                                    </span>
                                </td>
                                <td class="text-end pe-4">
                                    <div class="d-inline-flex flex-column gap-1 align-items-end">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger py-1 px-3" style="min-width: 90px;"
                                                onclick="openDeleteModal('${deleteLink}', '${tempCategory.categoryName}')">
                        ...
                        <tr id="noCategoryMatchRow" style="display: none;">
                        ...
                        <c:if test="${empty categories}">
                            <tr>
                                <td colspan="3" class="text-center text-muted py-5">
                                    ...
                                    No categories available yet.<br/>
                                    <a href="${pageContext.request.contextPath}/category/showFormForAdd" class="btn btn-amazon btn-sm mt-3">
                                        + Add First Category
                                    </a>
                                </td>
                            </tr>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body text-center p-4">
                ...
                <p class="text-secondary mb-1">
                    Do you really want to delete category <strong id="deleteItemName" class="text-dark"></strong>?
                </p>
...
<script>
    ...
    // Category Live Search Function
    function filterCategories() {
        const input = document.getElementById("categorySearchInput").value.toLowerCase().trim();
        const rows = document.querySelectorAll(".category-row");
        const noMatch = document.getElementById("noCategoryMatchRow");
        let visibleCount = 0;

        rows.forEach(row => {
            const name = row.querySelector(".category-name").textContent.toLowerCase();
            const id = row.querySelector(".category-id").textContent.toLowerCase();
